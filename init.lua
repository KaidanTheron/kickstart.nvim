...
vim.keymap.set('n', '<leader>qa', vim.diagnostic.open_float, { desc = 'Open [D]iagnostic [W]indow' })
...
vim.keymap.set('n', '<C-b>', '<Esc><Cmd>NvimTreeToggle<CR>')
...
if vim.g.neovide then
  ...
  vim.cmd [[lua vim.g.neovide_scale_factor = 0.80]]
  vim.cmd [[set linespace=18]]
end
